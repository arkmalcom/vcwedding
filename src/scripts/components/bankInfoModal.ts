...
bankInfoModal.innerHTML = `
  <div class="relative bg-lime-950 w-full max-w-lg p-4 rounded-lg shadow-md font-serif border border-lime-700">
    ...
    <div id="modal-content" class="justify-center items-center text-center border-2 border-lime-700 bg-lime-800 relative p-4 rounded-lg">
        <h1 i18n-key="bankInfoModal.title" class="py-4 text-amber-50 font-stylized text-2xl pb-6"></h1>
        <p i18n-key="bankInfoModal.content" class="text-amber-50"></p>
        <h2 i18n-key="bankInfoModal.malcomHeader" class="text-amber-50 font-semibold"></h2>
        <p i18n-key="bankInfoModal.malcomContent" class="text-amber-50"></p>
        <h2 i18n-key="bankInfoModal.sheylaHeader" class="text-amber-50 font-semibold"></h2>
        <p i18n-key="bankInfoModal.sheylaContent" class="text-amber-50"></p>
    </div>
  </div>
`;
