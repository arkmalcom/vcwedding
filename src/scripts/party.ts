  ...
  <div class="flex w-screen h-screen flex-col items-center justify-start border-b-4 border-amber-950 lg:space-y-8 space-y-2">
    ...
    <div class="flex flex-col rounded-lg shadow-md bg-amber-50 w-80 h-72 justify-start items-center z-10 p-2">
        ...
        <a href="#" target="_blank" rel="noopener noreferrer">
            <button i18n-key="party.recommendSong" class="fade-button opacity-0 py-1 h-20 w-64 rounded-md border-4 shadow-md px-2 border-amber-950 bg-amber-800 text-amber-100 uppercase font-black font-serif hover:text-amber-200 text-lg"></button>
        </a>
    </div>
    <div class="flex flex-col rounded-lg shadow-md bg-amber-50 w-80 h-72 justify-start items-center z-10 p-2">
        ...
        <a href="#" target="_blank" rel="noopener noreferrer">
            <button i18n-key="party.dressCodeButton" class="relative top-2/3 fade-button opacity-0 py-1 h-20 w-64 rounded-md border-4 shadow-md px-2 border-amber-950 bg-amber-800 text-amber-100 uppercase font-black font-serif hover:text-amber-200 text-lg"></button>
        </a>
    </div>
    </div>
  </div>
